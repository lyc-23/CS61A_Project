...
def is_always_roll(strategy, goal=GOAL):
    ...
    score0, score1 = 0, 0
    strategy_initial_get_score = strategy(score0, score1)
    while score0 < goal:
        score1 = 0
        while score1 < goal:
            if strategy(score0, score1) != strategy_initial_get_score:
...
def max_scoring_num_rolls(dice=six_sided, times_called=1000):
    ...
    # BEGIN PROBLEM 9
    "*** YOUR CODE HERE ***"
    result = make_averaged(roll_dice)(1,dice)
    numroll = 1
    for i in range(1, 11):
        cnt = make_averaged(roll_dice)(i,dice)
        if cnt > result :
            result = cnt
            numroll = i
    return numroll
...
def final_strategy(score, opponent_score):
    ...
    *** YOUR DESCRIPTION HERE ***
    """
    # BEGIN PROBLEM 12
    return sus_strategy(score, opponent_score)  # Remove this line once implemented.
    # END PROBLEM 12
